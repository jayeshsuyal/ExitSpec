...
gate, adds four exact B13 Chromium cases, runs the B13 adversarial pack suite,
then runs the full engineering and distribution checks. It fails on any skip,
error, or failure:
