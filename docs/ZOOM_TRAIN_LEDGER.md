...
| [#135](https://github.com/jayeshsuyal/ExitSpec/pull/135) | Adversarial E2E, regression audit, demo readiness | `codex/zoom-train-pr7-adversarial-e2e` | `a2e8793` + ledger `f9e34cb` | [run 32932424696](https://github.com/jayeshsuyal/ExitSpec/actions/runs/32932424696) | Python 3.12/3.13, Browser E2E, operator, npm audit CI green; merge pending |
...
- `pip_audit` is not installed in the project virtualenv; operator `npm audit`
  completed offline with zero vulnerabilities, and the CI workflow remains the
  authoritative networked dependency-audit gate.
