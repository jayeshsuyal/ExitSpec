...
| PR6 pending | Guided `/app` handoff | `codex/zoom-train-pr6-guided-app` | `3f12129` | pending | Full Python, distribution, operator, HTTP, and Chromium checks green; not yet opened |
